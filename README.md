...
| M30 보안·profile·최소 DFU | **6/8 진행** | 8/10 test ID PASS. 유선 OOB·profile·서명 부트와 secure BLE DFU 정상 10/10·negative 5×20·rollback PASS |
...
현재 개발 체크포인트는 **M30-W06 완료**이며 다음 구현 단계는 W07 세 보드 secure multi-link
통합 HIL입니다. 실제 전원 차단은 W08 `M30-POWER-01` 직전에 사람 개입을 요청합니다.
...
| M30 — 진행 | link별 security·pairing, 유선 OOB·bond/privacy, profile 7개, MCUboot·secure BLE DFU | W01~W06·8/10 test ID PASS. W07 세 보드 통합과 W08 실제 전원 복구가 남음 |
...
| 현재 개발·다음 작업 | [v0.5.0 개발 계획](00_Docs/TODO_v0.5.0.md) · [개발 인계](00_Docs/HANDOFF.md) — M30-W06 완료, W07 진행 |
