...
Current-source Fixture 301 exact 9a63251·1,986개 기능 PASS와 T11 단독 회귀 완료 근거는 [73번 기록](<./00_Docs/04_검증 기록/73_T11_Fixture_301_current_source_TWI_회귀.md>)에 연결한다. 일곱 fixture의 원본 61,423개와 동일 컴파일 입력을 대조했으며 exact identity는 구분 보존한다. T12 Fixture 401~404 각 48개 PASS 뒤 405·406·407도 각각 12개를 완료했고 408도 완료했으며 다음은 Fixture 420 QDEC이고 M24/M25 전체·T13~T15·RC/공개 gate는 미완료다.
...
420 QDEC 최신 상태는 [84번 기록](<00_Docs/04_검증 기록/84_T12_Fixture_420_current_source_QDEC_검증.md>)을 따른다. **fc9f153 기능 48 PASS** 뒤 START 전 취소에서 STOP timeout을 발견했다. GPIO LOW 준비·복원으로 수정한 **a3d0ab5는 Host 656 PASS·1 조건부 SKIP, 정렬 359·pair build 2/2**이며 실기는 결선 유지 재확인 대기다. 실패한 B 대기 자원은 제어 리셋으로 정리했다. 420 최종 완료·430/440·T12 전체·T13 이후는 아직 미완료다.
