...
| 개발 소스 | `main` 기준선·`M31-MEM-OPT` 작업 브랜치, 소스 식별자 `0.4.1-dev` | v0.5.0을 목표로 BLE 확장·메모리 최적화 개발 중. 배포판에 없는 API·예제가 포함됨 |
...
| M31 ISO·Audio·DF·CS | **7/8 완료** | W01 원장·capability, W02 raw ISO, W03 LE Audio 11/11, W04 DF, W05 CS, W06 자원·수명주기·M19~M30 회귀, W07 설치 예제 49/49·3보드 역할 HIL 완료. W08 미착수 |
...
현재 개발 체크포인트는 **M31-W01~W07 완료**입니다. W02의 공개
...
완료 범위를, [M31 TODO](00_Docs/TODO_M31.md)에서 완료한 DF·CS·자원 회귀·설치 예제 HIL과 남은 W08을 확인할 수 있습니다.
...
다음 순서는 W08입니다. 고정 NCS v3.4.0에서 제품 SDC DF IQ RX는 지원 밖이며,
...
| M31 — 7/8 완료 | W01 원장·capability, W02 raw ISO 11역할, W03 LE Audio 11개 하위 작업, W04 DF·W05 CS, W06 독립 image 자원·수명주기·M19~M30 회귀, W07 설치 예제 49/49·3보드 역할 HIL 완료 | W08 마감·Windows 릴리스 gate |
...
| 현재 개발·다음 작업 | [M31 TODO](00_Docs/TODO_M31.md) · [v0.5.0 개발 계획](00_Docs/TODO_v0.5.0.md) · [개발 인계](00_Docs/HANDOFF.md) — M31-W01~W07과 `M31-MEM-OPT` P0·P1·P2 완료, 다음 W08 |
