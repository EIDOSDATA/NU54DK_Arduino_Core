...
| M30 보안·profile·최소 DFU | **2/8 진행** | capability 7/7과 IO capability 5종 pairing 50/50 PASS. 유선 OOB W03 진행 |
...
현재 개발 체크포인트는 **M30-W02 완료**이며 다음 구현 단계는 M30-W03 유선 OOB·bond/privacy·
NFC adapter입니다.
...
| M30 — 진행 | link별 security·pairing, profile·최소 BLE DFU | W01 capability 7/7, W02 IO capability 5종 50/50 PASS. W03 유선 OOB부터 W08 실제 전원 복구까지 남음 |
...
| 현재 개발·다음 작업 | [v0.5.0 개발 계획](00_Docs/TODO_v0.5.0.md) · [개발 인계](00_Docs/HANDOFF.md) — M30-W02 완료, W03 진행 |
