...
| 개발 소스 | `0.5.0-RC1` 작업 브랜치, 소스 식별자 `0.4.1-dev` | M31·Windows RC 준비 완료. 배포판에 없는 API·예제가 포함됨 |
...
| M31 ISO·Audio·DF·CS | **8/8 완료** | W01 원장·capability, W02 raw ISO, W03 LE Audio 11/11, W04 DF, W05 CS, W06 자원·회귀, W07 예제/HIL, W08 Windows RC 준비 완료 |
| 후속 다중 Host | **3/8 완료, 후속 보류** | HOST-W01~HOST-W03 공통 backend·resolver·launcher 완료. HOST-W04 이후는 사용자 지시로 보류 |
| v0.5.0 릴리스 | 미공개 | 메모리 최적화·M31 8/8과 Windows 패키지·설치·RC 준비 완료. 별도 공개 승인·게시 gate 필요. M32/M33은 후속 버전 |

현재 개발 체크포인트는 **M31-W01~W08 완료**입니다. W02의 공개
...
완료 범위를, [M31 TODO](00_Docs/TODO_M31.md)와 [W08 완료 기록](<00_Docs/04_검증 기록/267_M31_W08_Windows_RC_준비와_M31_완료.md>)에서
DF·CS·자원 회귀·설치 예제 HIL·Windows RC 준비 완료를 확인할 수 있습니다.
...
P2의 오류·최악 부하, stack/heap 최종 유지 판정, 동일 조건 Nordic native FLASH/RAM 비교와 W08을
닫았고 다음 순서는 별도 v0.5.0 공개 승인입니다. 고정 NCS v3.4.0에서 제품 SDC DF IQ RX는 지원 밖이며,
...
| M31 — 8/8 완료 | W01 원장·capability, W02 raw ISO 11역할, W03 LE Audio 11개 하위 작업, W04 DF·W05 CS, W06 독립 image 자원·회귀, W07 예제/HIL, W08 Windows RC 준비 완료 | 별도 공개 승인·게시 gate |
...
| 현재 개발·다음 작업 | [M31 TODO](00_Docs/TODO_M31.md) · [v0.5.0 개발 계획](00_Docs/TODO_v0.5.0.md) · [개발 인계](00_Docs/HANDOFF.md) — M31 8/8과 Windows RC 준비 완료, 다음은 별도 공개 승인 |
