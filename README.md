...
개발 브랜치는 `0.5.0-RC1`입니다. M28~M31과 메모리 최적화 P0~P2, Windows RC 공개 검증을
완료했으며 다음 제품 단계는 정식 v0.5.0 검토입니다. 후속 기능과 다중 Host 계획은 TODO에서 관리합니다.
공개 패키지를 재현할 때는 작업 브랜치 대신 해당 release tag와 manifest를 사용합니다.
