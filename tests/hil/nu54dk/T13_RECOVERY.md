...
PWM/analogWrite/tone/Servo 충돌 3종은 후속
[116번 T14 기록](<../../../00_Docs/04_검증 기록/116_T14_자원_충돌_판정과_PWM_식별_교정.md>)에서
검증·판정 완료했습니다. 이 문서는 T13 당시 복구 범위와 실행법을 보존합니다.
...
`handover-preflight`, `handover`, 전환을 포함한 `spi-timing-diagnostic`은 사용자 결정으로 제외했습니다.
보존된 명령이나 예전 실행 대열로 다시 시작하지 않습니다. 기존 결과·제외 범위는
[109번](../../../00_Docs/04_검증%20기록/109_T13_S_세_복구_묶음_재검증.md)을 따릅니다.
