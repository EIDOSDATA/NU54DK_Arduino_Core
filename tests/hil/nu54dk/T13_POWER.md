...
아래는 당시 준비·진단한 설계 보관이며, 현재의 실행 순서나 SWD 스위치 조작 지시가 아니다.
...
초기 Host/target 준비와 중계 실패는 [110번](<../../../00_Docs/04_검증 기록/110_문서_정리와_T13_S_잔여_재개.md>),
후속 레지스터 진단은 [112번](<../../../00_Docs/04_검증 기록/112_T13_S_SPI_TWI_완료와_System_OFF_원인.md>),
최종 제외 결정은 [113번](<../../../00_Docs/04_검증 기록/113_T13_S_범위_종료와_U_준비.md>)에 보존한다. 현재 실기 잔여로 등록하지 않는다.
