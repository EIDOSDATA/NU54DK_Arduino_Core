...
2026-09-08 T13 S 후속: 사전검사35/36은 8966da5의 짧은 시험 결과이며 정식 안정성·복구100회 완료는0이다.
a6367ca에서 SPI 선행 시 C01 오류와 미사용 UART RTS/CTS 핀 선택 잔류를 확인해 T14 최소 수정을 준비했다.
새 source의 START 전 실제 PSEL 대조·영향 UART/C01 회귀를 거친 뒤 S를 이어간다.
