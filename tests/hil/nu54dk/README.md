...
v0.5.0은 완료한 M31과 Windows RC를 기준으로 별도 공개 승인을 기다립니다. `M31-MEM-OPT`에서
메모리 최적화 P0~P2를 완료했고 `0.5.0-RC1`에서 W04~W08을 닫았습니다. W06은 독립 ISO·Audio·DF·CS image의 자원·
...
UARTE00 4신호+GND 결선에서 정상 180초, RTS/CTS 200회와 TX/RX 취소 400회를 완료했습니다.
S 종료 근거는 [113번](<../../../00_Docs/04_검증 기록/113_T13_S_범위_종료와_U_준비.md>),
U 완료와 T13 종료는 [115번](<../../../00_Docs/04_검증 기록/115_T13_U_UART00_완료와_T13_종료.md>)을 확인합니다.
