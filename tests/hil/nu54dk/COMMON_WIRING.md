...
현재 실행은 [100번](../../../00_Docs/04_검증%20기록/100_T12_공통_기능_묶음과_T13_조합_확정.md)을 따른다. 4e48252 GPIO2502·3334b17 steadyPWM675·0db0689 추가PWM288은 PASS다. b5c86a4 QDEC은26조건 뒤3999/4000으로 중단해 GPIO 독립 계측을 준비한다. I2S는b5c86a4에서432/432 PASS·입력 복귀를 완료했다. e521825 QDEC 독립 GPIO 진단을 실행 중이다. `--section signals`는675+288+240+432, `additional-signals`는288+240+432, `qdec-i2s`는240+432를 선택한다. 각 실행은 새 source/501/cleanup 증거를 남긴다. [T13 계획](T13_PLAN.md)의 C→S→U 두 결선 변경은 후속이며 현재 C를 유지한다.
