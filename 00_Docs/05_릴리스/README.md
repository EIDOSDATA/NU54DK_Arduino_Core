...
| `0.5.0-RC1`의 `0.4.1-dev` | v0.5.0을 준비하는 개발 소스; M28~M31 완료 |
...
| M31 검증 | W01~W08 완료 8/8; W03 LE Audio 11/11, W04 DF·W05 CS, W06 자원/회귀, W07 예제/HIL, W08 Windows RC 준비 PASS |
| `v0.5.0` | 미공개; Windows package·설치·RC 준비 완료, 별도 공개 승인·게시·다운로드 smoke 대기 |
...
완료한 메모리 최적화 P0~P2·W04 DF·W05 CS·W06 자원/회귀·W07 설치 예제/세 보드 역할 재배치와
W08 API·지원표·Windows package·설치·lifecycle·RC 준비를 보존하고, 다음은 별도 공개 승인입니다.
...
`M31-MEM-OPT`에서 완료한 P0·P1·P2는 `0.5.0-RC1`의 M31 마감에 반영했습니다. 지원 범위 오류·최악 부하,
...
W08 준비 완료를 공개 릴리스 완료로 확대하지 않습니다.
