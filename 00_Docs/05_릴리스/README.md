...
| `main`의 `0.4.1-dev` | v0.5.0을 준비하는 개발 소스; M28 완료, M29 W01~W06 완료 |
| M29 후속 검증 | W07-C Signed Write·EATT 실기 완료; W07-D/E와 W08 미완료, 작업 묶음 6/8(75%) |
| `v0.5.0` | 미공개; 개발 소스의 새 기능이 v0.4.1 설치본에 포함된 것은 아님 |
