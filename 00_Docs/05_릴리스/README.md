...
| `main`의 `0.4.1-dev` | v0.5.0을 준비하는 개발 소스; M28·M29 완료, M30 W01~W07 완료·W08 미완료, M31~M33 미착수 |
| M29 검증 | W01~W08 8/8·test ID 10/10, 세 보드 통합·회귀와 Windows/Intel 기본 GATT PASS |
| M30 검증 | 7/8 작업·test ID 9/10 PASS. W08 실제 전원 차단 0/12·사용자 중지 상태이며 재개 준비 복구 필요 |
| `v0.5.0` | 미공개; HOST-W01~W03 완료, W04~W08 미완료. M33에서 기능·Host release gate를 함께 판정 |

진행 중인 작업과 남은 검증은 [v0.5.0 TODO](../TODO_v0.5.0.md)를 따릅니다. 개발 문서의
M28/M29/M30의 개발 PASS를 공개 v0.4.1 패키지의 기능 추가나 v0.5.0 릴리스 완료로 해석하지 않습니다.
다중 Host의 시작 시점·지원 범위·검증 절차는
[v0.5.0 Host 계약](<../02_빌드 설계/10_v0.5.0_다중_Host_지원_착수_계약.md>)에 고정합니다.

문서 전면 검토 후의 실행 순서와 Adafruit 개선 과제는
[개선 마일스톤](<../01_아두이노 코어 설계/18_문서_전면검토와_개선_마일스톤.md>)을 따릅니다.
M33에는 기존 API의 목적별 예제·안내를 보강하고, 새 공개 API를 포함한 후속 ARF 과제의 배포
