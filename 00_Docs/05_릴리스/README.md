...
| `main`의 `0.4.1-dev` | v0.5.0을 준비하는 개발 소스; M28·M29·M30 완료, M31은 W01~W04 완료로 4/8 |
...
| M31 검증 | W01~W04 완료; W03 LE Audio profile 11/11, W04 DF PASS. W05~W08은 완료 아님 |
...
완료한 P2·W04를 넘어 W05 또는 릴리스까지 완료 처리하지 않습니다.
