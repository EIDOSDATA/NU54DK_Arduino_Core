...
| `main`의 `0.4.1-dev` | v0.5.0을 준비하는 개발 소스; M28·M29 완료, M30~M33 미착수 |
| M29 검증 | W01~W08 8/8·test ID 10/10, 세 보드 통합·회귀와 Windows/Intel 기본 GATT PASS |
| `v0.5.0` | 미공개; M30부터 다중 Host 구현을 병행하고 M33에서 기능·Host release gate를 함께 판정 |

진행 중인 작업과 남은 검증은 [v0.5.0 TODO](../TODO_v0.5.0.md)를 따릅니다. 개발 문서의
M28/M29 PASS를 공개 v0.4.1 패키지의 기능 추가나 v0.5.0 릴리스 완료로 해석하지 않습니다.
