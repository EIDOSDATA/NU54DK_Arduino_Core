...
2026-09-08 소유자 지시로 0.3.0 미만 stable·RC·preview를 공개 목록에서 제거합니다.
Boards Manager를 통한 구버전 downgrade는 제공하지 않습니다. 기존 설치를 자동으로 삭제하지
않으며, 역사적 재현은 [106번 원본 보존 기록](<../../04_검증 기록/106_Git_이력_정리와_구버전_패키지_공급_종료.md>)을 따릅니다.
