...
> **지원 종료:** 현재 설치·지원 버전은 [v0.4.1](../v0.4.1/README.md) 하나입니다. 이 RC는
...
v0.4.0은 Peripheral Parity 범위로 완료했습니다. 이후 계획은 [v0.5.0 TODO](../../TODO_v0.5.0.md)를
따르며 이 과거 M24 제안을 현행 약속으로 사용하지 않습니다.
