...
> **역사적 M24 작업 1 기준선:** 아래 신규 driver·HIL 미구현과 작업 2 계획은 당시 상태다.
...
후속 구현 결과는 [35번 기록](35_M24_Serial_Fabric_공통_backend_기준선.md)에 보존한다. 현재 실행 범위와 우선순위는 [현재 TODO](../TODO_v0.5.0.md)를 따른다.
