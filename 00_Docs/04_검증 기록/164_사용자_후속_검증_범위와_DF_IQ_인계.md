...
> **역사 결정:** 아래 구현 상태·재개 branch는 2026-09-16 기준이다. 현재는 [HANDOFF](../HANDOFF.md)를 따른다.
> 후속 [259번](259_M31_P2_DF_고정_SDK_지원_경계.md)에서 제품 SDC IQ RX를 `UNSUPPORTED`·P2 비차단으로 확정했다.
