...
> S 56 PASS + System OFF 2건 제외와 U 준비 당시 상태는 [113번](113_T13_S_범위_종료와_U_준비.md),
> 후속 U 완료는 [115번](115_T13_U_UART00_완료와_T13_종료.md)에 기록했습니다. 아래 다음 순서는 현행 재실행 지시가 아닙니다.
...
이전 다음 실행 순서는 폐기하며 완료한 S를 다시 실행하지 않는다. U 실기는 후속 115번에서 완료했다.
