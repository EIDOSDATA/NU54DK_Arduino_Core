...
Controller는 B/role 2만 사용했다. [USB 재식별](evidence/t12-fixture404-e080bbc/usb-inventory.json)은
A D/COM5·COM6, B E/COM7·COM8과 기존 exact UID 두 개를 확인했다.

[build evidence](evidence/t12-fixture404-e080bbc/target-build-evidence.json), [artifact 색인](evidence/t12-fixture404-e080bbc/target-artifact-index.json),
[exact image](evidence/t12-fixture404-e080bbc/exact-images.json)에 두 역할의 새 HEX/ELF·설정·빌드 기록·hash를 보존했다.
NCS v3.4.0·bundle dcbdc366a1·GNU Arm 14.3·bundled Python·pyOCD 0.42.0을 사용했다.
[403 대비 입력 대조](evidence/t12-fixture404-e080bbc/build-input-comparison.json)는 두 역할의 컴파일 소스·설정·소속·메모리가
...
| 원본 | SHA-256 |
| --- | --- |
| [결과 JSON](evidence/t12-fixture404-e080bbc/fixture404-attempt1.json) | `e22185064b3f1078cd430081063bfc5930ff53908f9bcd863ba15e92c4dd4d26` |
| [journal](evidence/t12-fixture404-e080bbc/fixture404-attempt1.json.jsonl) | `ea18113a53f9e4a07c0bbe482878d64d3597d0cc15c1b0c661ee4cbe7216a809` |

양쪽 flash와 전체 cycle은 첫 실행에서 통과했다. Sector erase·`auto_unlock=false`를 사용했고
mass erase/recover·SWD 하향·재시도는 없었다. [종료 read-only 확인](evidence/t12-fixture404-e080bbc/postflight.json)은
...
[다음 핀맵 감사](evidence/t12-fixture404-e080bbc/next-wiring-audit.json)에 GPIO/connector 대응을 보존했다.
