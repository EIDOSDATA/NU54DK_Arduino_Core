...
현재 진행·잔여·제외 범위는 TODO에서 관리하고, 최신 source별 원인 분석·실행 증거와 문서 감사는
[110번 S 정리](110_문서_정리와_T13_S_잔여_재개.md)에서 확인합니다. 이 목차에 진행 수치를 복제하지 않습니다.

## 최근 확인할 기록

| 기록 | 용도 |
| --- | --- |
| [112 — SPI·TWI 완료와 System OFF 원인](112_T13_S_SPI_TWI_완료와_System_OFF_원인.md) | S 56/58·레지스터·공식 예제·물리 SWD 격리 조건 |
...
<details>
<summary>v0.4.0 최근 실기·인계 — 94~112</summary>
