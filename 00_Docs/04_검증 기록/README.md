...
- [99 — 공통 결선 검사와 승인 전 자동 진행 계획](99_공통_결선_검사와_승인_전_자동_진행_계획.md): Fixture 501의 첫 P1.10 실패 보존과 d8d1e13 재검사 102+3 PASS, 동시 30분·대표 한 조합 60분 기준, T21까지의 자동 진행 및 현장 조작 경계.
