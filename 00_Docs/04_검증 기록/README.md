...
[114번](114_전체_문서_정비와_남은_마일스톤.md), U 완료와 T13 종료는
...
[124번](124_T22전_QDEC_지원_범위_재확정.md), 정식 공개와 T24/T25 마감은
[125번](125_v0.4.0_정식_릴리스_공개와_T24_T25_마감.md)에서 확인합니다.
...
| [114 — 전체 문서 정비와 당시 남은 마일스톤](114_전체_문서_정비와_남은_마일스톤.md) | 전수 검토·현행/역사 분리·U 실행 전 체크포인트 |
...
<details>
<summary>v0.4.0 최근 실기·인계·공개 — 94~125</summary>
