...
| 기록 | 용도 |
| --- | --- |
| [131 — M28-W01 Capability image와 Host·target 준비](131_M28_W01_Capability_image와_Host_target_준비.md) | `M28CAP/1`·fail-closed parser·고정 NCS target 1/1 PASS, 실제 HCI NOT RUN |
...
| [125 — v0.4.0 정식 릴리스 공개와 T24/T25 마감](125_v0.4.0_정식_릴리스_공개와_T24_T25_마감.md) | **T22~T25 완료·공개 URL 설치 30/30·Upload·수명주기 PASS** |
| [124 — T22 전 QDEC20/21 지원 범위 재확정](124_T22전_QDEC_지원_범위_재확정.md) | **완료·QDEC 지원 계약과 T19~T21 영향 재검증 PASS** |
...
<details>
<summary>v0.4.0 실기·공개, v0.4.1 유지보수와 M28 착수 — 94~131</summary>
...
- [131 — M28-W01 Capability image와 Host·target 준비](<131_M28_W01_Capability_image와_Host_target_준비.md>) — **고정 protocol·Host parser·target 1/1 PASS, 실제 HCI NOT RUN**
