...
> T13 PASS로 바꾸지 않으며, S 종료는 [113번](113_T13_S_범위_종료와_U_준비.md),
> U 완료와 T13 종료는 [115번](115_T13_U_UART00_완료와_T13_종료.md)을 따른다.
...
실행하지 않은 추가 결합을 PASS로 바꾸지 않는다. U 실기는 후속 115번에서 완료했다.
