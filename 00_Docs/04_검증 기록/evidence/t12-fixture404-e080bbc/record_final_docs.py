...
destination = Path(r'C:\Users\eidos\GitHub\NU54DK_Arduino_Core\00_Docs\04_검증 기록\evidence\t12-fixture404-e080bbc')
name = 'gate-docs-final.log'
content = (work / name).read_text(encoding='utf-8-sig').replace('\r\n', '\n')
assert 'M12_GATE_PASS=docs' in content and 'PASS: 186 files' in content
