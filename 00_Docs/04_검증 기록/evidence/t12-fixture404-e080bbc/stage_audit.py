...
destination = '00_Docs/04_검증 기록/evidence/t12-fixture404-e080bbc'
documents = ['README.md', '00_Docs/README.md', '00_Docs/TODO_v0.4.0.md', '00_Docs/01_아두이노 코어 설계/02_구현_로드맵.md', '00_Docs/01_아두이노 코어 설계/14_리팩토링/README.md', '00_Docs/01_아두이노 코어 설계/14_리팩토링/05_리팩토링_진행_체크리스트.md', '00_Docs/04_검증 기록/README.md', '00_Docs/04_검증 기록/77_T12_Fixture_404_current_source_PWM_ADC_검증.md', 'tests/hil/nu54dk/README.md']
...
assert git('rev-parse', 'HEAD').decode().strip() == 'e080bbc8f07a0ad751d83dacdb259d395b69be5b'
