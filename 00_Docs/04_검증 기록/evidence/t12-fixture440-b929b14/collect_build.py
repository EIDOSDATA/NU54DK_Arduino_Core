...
for old, new in ((WORK.parent / 'r13/u4f-artifact-index.json', WORK / 'target-artifact-index.json'),
                 (Path(r'C:\u4f\m12-build-evidence.json'), WORK / 'target-build-evidence.json')):
