...
destination = '00_Docs/04_검증 기록/evidence/t11-fixture201-0f429e7'
documents = ['README.md', '00_Docs/README.md', '00_Docs/TODO_v0.4.0.md', '00_Docs/01_아두이노 코어 설계/02_구현_로드맵.md', '00_Docs/01_아두이노 코어 설계/14_리팩토링/README.md', '00_Docs/01_아두이노 코어 설계/14_리팩토링/05_리팩토링_진행_체크리스트.md', '00_Docs/04_검증 기록/README.md', '00_Docs/04_검증 기록/70_T11_Fixture_201_current_source_SPI_회귀.md', 'tests/hil/nu54dk/README.md']
...
assert git('rev-parse', 'HEAD').decode().strip() == '0f429e7ab9b5b8e24f4ff19e47abe60014975547'
