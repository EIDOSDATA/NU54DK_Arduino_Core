...
for role, scenario in ((1, 'nucode.v04.pair_dut'), (2, 'nucode.v04.pair_peer')):
    ...
    for path, target in ((directory.parent / 'build.log', work / f'role{role}-build.log'),
    ...
    assert 'undefined reference' in (directory.parent / 'build.log').read_text(encoding='utf-8')
