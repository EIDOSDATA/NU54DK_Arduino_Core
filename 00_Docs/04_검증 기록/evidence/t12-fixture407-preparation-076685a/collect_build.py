...
for old, new in ((work.parent / 'r13/u3n-artifact-index.json', work / 'target-artifact-index.json'),
...
old = json.loads((work.parent / 't12-fixture406/target-artifact-index.json').read_text(encoding='utf-8'))
rows = []
...
product_delta = subprocess.check_output(['git', 'diff', '--name-only', '96f38e9486c69cda2c76b48029bc0dc9404d9709', source,
...
payload = {'source': source, 'prior_fixture406_source': '96f38e9486c69cda2c76b48029bc0dc9404d9709',
           'product_build_tool_board_delta': [], 'pair_builds': rows,
           'physical_claim': '407 must run on these new images; prior fixture results retain their original source identity'}
