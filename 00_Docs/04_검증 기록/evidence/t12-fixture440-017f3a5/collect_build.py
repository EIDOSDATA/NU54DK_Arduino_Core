...
for old, new in ((WORK.parent / 'r13/u4c-artifact-index.json', WORK / 'target-artifact-index.json'),
                 (Path(r'C:\u4c\m12-build-evidence.json'), WORK / 'target-build-evidence.json')):
