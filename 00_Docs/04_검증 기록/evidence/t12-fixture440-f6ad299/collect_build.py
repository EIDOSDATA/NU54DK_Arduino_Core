...
for old, new in ((WORK.parent / 'r13/u4d-artifact-index.json', WORK / 'target-artifact-index.json'),
                 (Path(r'C:\u4d\m12-build-evidence.json'), WORK / 'target-build-evidence.json')):
