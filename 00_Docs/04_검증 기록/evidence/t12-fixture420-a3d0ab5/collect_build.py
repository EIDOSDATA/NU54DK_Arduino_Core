...
for old, new in ((WORK.parent / 'r13/u3t-artifact-index.json', WORK / 'target-artifact-index.json'),
                 (Path(r'C:\u3t\m12-build-evidence.json'), WORK / 'target-build-evidence.json')):
