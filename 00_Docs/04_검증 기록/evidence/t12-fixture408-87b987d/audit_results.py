...
path = work / 'fixture408-attempt2.json'
...
assert result['fixture_id'] == 408 and result['core_revision'] == source
...
for vector in plan:
    ...
    assert row['id'] == f'V04-ANALOG-SIGNAL/408/2/{vector}/repeat-1'
...
audit = {
    'status': 'passed', 'fixture_id': 408, 'source': source, 'attempt': 2,
