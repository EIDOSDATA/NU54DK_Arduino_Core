...
with ProbeLocks(UIDS), ExitStack() as stack:
    for uid, digest, image in zip(UIDS, HASHES, images):
        ...
        enable = {name: target.read32(address) for name, address in
            [('POWER_CONSTLATSTAT', 0x5010E520), ('PDM20', 0x500D0500), ('PDM21', 0x500D1500), ('SPIS21', 0x500C7500),
...
startup = json.loads((WORK / 'continuous-startup-pins.json').read_text(encoding='utf-8'))
