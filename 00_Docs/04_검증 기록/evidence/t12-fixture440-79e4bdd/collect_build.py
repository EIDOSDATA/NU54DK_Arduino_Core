...
for old, new in ((WORK.parent / 'r13/u4g-artifact-index.json', WORK / 'target-artifact-index.json'),
                 (Path(r'C:\u4g\m12-build-evidence.json'), WORK / 'target-build-evidence.json')):
