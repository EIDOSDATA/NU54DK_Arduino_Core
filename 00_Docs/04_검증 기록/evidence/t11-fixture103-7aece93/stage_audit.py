...
destination = '00_Docs/04_검증 기록/evidence/t11-fixture103-7aece93'
documents = ['README.md', '00_Docs/README.md', '00_Docs/TODO_v0.4.0.md', '00_Docs/01_아두이노 코어 설계/02_구현_로드맵.md', '00_Docs/01_아두이노 코어 설계/14_리팩토링/README.md', '00_Docs/01_아두이노 코어 설계/14_리팩토링/05_리팩토링_진행_체크리스트.md', '00_Docs/04_검증 기록/README.md', '00_Docs/04_검증 기록/69_T11_Fixture_103_current_source_UART_회귀.md', 'tests/hil/nu54dk/README.md']
...
assert git('rev-parse', 'HEAD').decode().strip() == '7aece93395f0d74272816894a18c2c5e3f1a2abe'
...
assert len(paths) == len(documents) + 2 * len(manifest['files']) + 6
