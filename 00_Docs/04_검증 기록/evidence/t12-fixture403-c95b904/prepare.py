...
confirmation = fixture.confirmation_template(images, UIDS, 403)
...
fixture.validate_confirmation(confirmation, images, UIDS, 403)
...
raise SystemExit(runner.main(['--dut', UIDS[0], '--peer', UIDS[1], '--build-root', str(BUILD), '--pyocd', str(BUNDLE / 'opt/bin/Scripts/pyocd.exe'), '--fixture', '403', '--swd-frequency-hz', '10000000']))
