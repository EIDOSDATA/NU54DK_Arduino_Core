...
path = work / 'fixture403-attempt1.json'
...
assert result['fixture_id'] == 403 and result['core_revision'] == source
...
for vector in plan:
    ...
    assert row['id'] == f'V04-ANALOG-SIGNAL/403/2/{vector}/repeat-1'
...
audit = {
    'status': 'passed', 'fixture_id': 403, 'source': source, 'attempt': 1,
