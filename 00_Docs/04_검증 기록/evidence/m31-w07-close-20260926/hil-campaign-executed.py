...
HIL = Path(__file__).resolve().parents[3] / "GitHub" / "NU54DK_Arduino_Core" / "tests" / "hil" / "nu54dk"
if not HIL.is_dir():
    HIL = Path(r"C:\Users\eidos\GitHub\NU54DK_Arduino_Core\tests\hil\nu54dk")
...
def main() -> int:
    ...
    parser.add_argument("--sdk-root", type=Path, default=Path(r"C:\Users\eidos\ncs\v3.4.0"))
