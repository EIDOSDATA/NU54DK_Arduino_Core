...
confirmation = fixture.confirmation_template(images, UIDS, 101)
...
fixture.validate_confirmation(confirmation, images, UIDS, 101)
...
raise SystemExit(runner.main(['--dut', UIDS[0], '--peer', UIDS[1], '--build-root', str(BUILD), '--pyocd', str(BUNDLE / 'opt/bin/Scripts/pyocd.exe'), '--fixture', '101', '--swd-frequency-hz', '10000000']))
