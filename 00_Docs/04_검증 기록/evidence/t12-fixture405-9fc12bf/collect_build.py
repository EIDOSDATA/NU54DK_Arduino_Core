...
for old, new in ((work.parent / 'r13/u3l-artifact-index.json', work / 'target-artifact-index.json'),
...
old = json.loads((work.parent / 't12-fixture404/target-artifact-index.json').read_text(encoding='utf-8'))
rows = []
for before, after in zip(old['targets'], index['targets']):
    ...
    assert changed == ['tests/zephyr/v04_pair_hil/src/main.cpp', 'tests/zephyr/v04_pair_hil/src/signal_hil.cpp']
...
product_delta = subprocess.check_output(['git', 'diff', '--name-only', 'e080bbc8f07a0ad751d83dacdb259d395b69be5b', source,
...
payload = {'source': source, 'prior_fixture404_source': 'e080bbc8f07a0ad751d83dacdb259d395b69be5b',
           'product_build_tool_board_delta': [], 'pair_builds': rows,
           'physical_claim': '405 must run on these new images; prior fixture results retain their original source identity'}
