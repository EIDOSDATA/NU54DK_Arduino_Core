...
command=[str(cli),'--config-file',str(root/'arduino-cli.yaml'),'compile','--verbose','--fqbn','nucode:zephyr:nu54dk','--board-options','feature_set=standard','--build-path',str(root/'retry-littlefs'),str(platform/'libraries/LittleFS/examples/LittleFSPersistence')]
