...
> 이 문서는 M10 preview의 당시 검증 기록이다. 해당 공개 공급은 2026-09-08 종료했다.
> 아래 URL·자산 크기·해시는 역사적 식별 근거이며 현재 설치 안내가 아니다. 복원 경로는 [106번 공급 종료 기록](106_Git_이력_정리와_구버전_패키지_공급_종료.md)을 따른다.
