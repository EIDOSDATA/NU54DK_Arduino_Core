# T11 Fixture 301 current-source TWI 회귀와 통신 단독 검증 완료
...
[USB 재식별](evidence/t11-fixture301-9a63251/usb-inventory.json)에서 A D/COM5·COM6, B E/COM7·COM8과 두 exact UID SHA를 확인했다.

[산출물 색인](evidence/t11-fixture301-9a63251/target-artifact-index.json), [build evidence](evidence/t11-fixture301-9a63251/target-build-evidence.json),
[exact image](evidence/t11-fixture301-9a63251/exact-images.json)에 새 clean source의 두 역할 이미지와 hash·mailbox 위치를 보존했다.
...
[독립 결과 감사](evidence/t11-fixture301-9a63251/results-audit.json)는 조합당 331개, 전체 고유 ID 1,986개의 계획·실제 순서와
...
[전체 묶음 감사](evidence/t11-fixture301-9a63251/t11-coverage-audit.json)는 일곱 fixture의 원본 journal hash·실제 기능 수·고유 ID와
...
[빌드 입력 대조](evidence/t11-fixture301-9a63251/build-input-comparison.json)는 이전 여섯 fixture의 양쪽 image와 이번 image 사이
...
- [전체 JSON](evidence/t11-fixture301-9a63251/fixture301-attempt1.json)·[journal](evidence/t11-fixture301-9a63251/fixture301-attempt1.json.jsonl)·[실행 log](evidence/t11-fixture301-9a63251/fixture301-attempt1.log)
- [실행 wrapper](evidence/t11-fixture301-9a63251/run.py)·[환경/UID 비공개](evidence/t11-fixture301-9a63251/runtime.py)·[사전 확인](evidence/t11-fixture301-9a63251/preflight.log)
- [종료 확인](evidence/t11-fixture301-9a63251/postflight.json)·[원본 byte/hash 목록](evidence/t11-fixture301-9a63251/raw-files.json)

종료 후 추가 flash/reset/fixture 명령 없이 양쪽 CPUID `0x411FD210`과 full 40-byte commit·role을 읽어
통과했다. CPU snapshot은 A SLEEPING·B SLEEPING이다. 양쪽 9a63251 DUT/peer image와 Fixture 301 결선을 유지한다.
기존 실패·build/image·증거·공개 자산은 보존했으며 추가 제거할 불용 파일은 확인되지 않았다.
최종 GitHub Actions 상태는 미확인이다.

## 문서와 증거 검증

활성 문서 9개에 결과와 다음 결선을 반영했다. Markdown UTF-8·내부 링크 182개, 계약 45개,
inventory 75개·Serial identity 23개·System capability 16개를 통과했다. Readiness는 필수 16개 중
blocker 8개를 유지한다. [software 검사 기록](evidence/t11-fixture301-9a63251/software-verification.json)에
canonical 명령과 log hash를 보존했다. 제품 코드 변경이 없어 이전 full Host·package·전체 target
결과는 해당 source의 역사 증거로 유지한다.

이번 실행·준비 입력 35개를 UTF-8/LF 사본과 원본 byte gzip으로 보존하고 hash·복원 일치·
