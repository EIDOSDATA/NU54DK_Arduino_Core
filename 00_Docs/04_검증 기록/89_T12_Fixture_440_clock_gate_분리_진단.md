...
처음 안내한 20~40 분은 진단·재시험 계획치였으며, 결선 점검과 새로운 실패 때문에 완료 시간을 확정할 수 없다. PDM/T12 전체 완료는 아직 아니고, T12 PWM capture·ADC calibration/다중 채널·timer/event, T13 이후·T14 공용 PWM·readiness 미해결 8 개는 유지한다.
