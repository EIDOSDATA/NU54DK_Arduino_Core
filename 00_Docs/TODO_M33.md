...
| 현재 공개·개발 | stable 지원 `v0.4.1`, 공개 후보 `v0.5.0-rc.1`; M33은 후속 버전 계획 |
| 최종 갱신일 | 2026-09-27 |
...
공개 `v0.5.0-rc.1` 승인·게시·설치 smoke도 닫았다. 정식 stable 승격은 [v0.5.0 TODO](TODO_v0.5.0.md)에서
별도로 관리한다. M33-W07~W08은 추가 기능과 다중 Host를 포함하는
...
M31 Windows RC에서 완료한 package·설치 gate의 절차와 증거를 재사용하되, 후속 기능·Host·
