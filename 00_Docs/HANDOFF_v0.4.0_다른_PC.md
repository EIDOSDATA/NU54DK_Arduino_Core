...
12. [123번 T21 stable 패키지와 최종 검사](<04_검증 기록/123_T21_stable_패키지와_최종_검사.md>)
13. [124번 T22 전 QDEC 지원 범위 재확정](<04_검증 기록/124_T22전_QDEC_지원_범위_재확정.md>)
14. [125번 v0.4.0 정식 공개와 T24/T25 마감](<04_검증 기록/125_v0.4.0_정식_릴리스_공개와_T24_T25_마감.md>)
15. [T13 계획·U 결선](../tests/hil/nu54dk/T13_PLAN.md)
...
지원 범위와 T19~T25는 완료됐습니다. `v0.4.0`은 GitHub Release와 stable index에 공개됐고,
공개 URL 설치 수명주기도 PASS했습니다.

현재 `main`은 T16 `fabric` profile과 `NUCODE Peripheral Fabric` library를 포함합니다. v0.4 stable은
library 9개·예제 30개이고 이전 v0.3 stable은 8개·29개입니다. T17 문서·지원 원장은 119번, T18 stable
...
QDEC 공개 지원 변경 뒤 영향 T19~T21도 124번에서 다시 통과했습니다. T22 승인, T23 공개,
T24 공개 URL 검증과 T25 마감은 125번에 기록했습니다. v0.4.0에서 재개할 미완료 단계는 없으며
후속 개발은 최신 제품 로드맵과 새 작업 지시에서 시작합니다.
