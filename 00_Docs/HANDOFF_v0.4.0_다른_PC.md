...
고정 serial 예행21/21, 정식100회 UART20 TX1/21 완료. I2S 공급 생략 예행2/4 PASS 뒤 PDM20 반복 STOP 실패를 보존했다.
직접 읽기에서 양쪽 주변장치 off·GPIO17입력을 확인했고 HIL 반복 해제 처리를 수정한다.
C:/tr13dev는clean03f5ba4 실기용, main은 수정·문서·증거 갱신용이다. 상세104/105 및 TODO3.67을 따른다.
