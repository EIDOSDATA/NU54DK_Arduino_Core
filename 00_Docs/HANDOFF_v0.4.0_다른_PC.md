...
1. 이번 C17 묶음은 GPIO/GPIOTE2502·PWM675+288·I2S432를 source별로 완료했다.
   ...
   [101번](<04_검증 기록/101_T12_QDEC_누산_누락_원인_분리.md>)의 증거·보완·최종 검사와 push/CI를 마무리한다.
2. 다음 작업의 허용 범위를 확인한 뒤 [T13 계획](../tests/hil/nu54dk/T13_PLAN.md)의 전용
...
3. T12의 남은 TIMER/event 반복·공유 회로 범위와 QDEC 보완은95·101번에 대조한다.
