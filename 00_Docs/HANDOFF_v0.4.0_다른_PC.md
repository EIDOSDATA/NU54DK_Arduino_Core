...
4. [T13 계획·U 결선](../tests/hil/nu54dk/T13_PLAN.md)
...
제외를 구분해 종료했고 U용 소프트웨어·image 준비도 완료했습니다. 다음 물리 단계는
U 재결선 확인과 U 실기입니다. 현재 요청 범위를 확인한 뒤 시작하며 S 확인을 새 U 결선
확인으로 재사용하지 않습니다. 완료한 S 시험·C05 1시간 soak를 다시 예약하지 않습니다.
