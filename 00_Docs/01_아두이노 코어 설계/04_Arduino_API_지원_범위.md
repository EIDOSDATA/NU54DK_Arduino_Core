...
2026-09-08 개발 문서 검토: 아래 표는 `v0.3.0` stable 계약을 유지한다. `v0.4.0` 후보의 진행·QDEC HOLD·T13 미실기 상태는 [실행 TODO](../TODO_v0.4.0.md)와 [102번 요구별 대조](<../04_검증 기록/102_개발_문서_전수_검토와_마일스톤_체크포인트.md>)를 따른다. 후보 기능의 source/build나 일부 HIL을 이 stable 지원 표에 자동 반영하지 않는다.
