...
| 문서 개정 | 1.8 |
| 문서 상태 | M23·M26 완료 / M24 온보드 기본·UART Fixture 101·102 PASS, 나머지 M24·M25 physical gate 대기 / M27 준비 중 |
...
- 상태: **작업 1~5 source/build/semantic 완료, 작업 6 온보드 기본·UART Fixture 101·102 PASS·나머지 HIL 대기** — 5개 block·23개 personality, 핀 bank, singleton/고급 API 경계,
  ...
  따른다. Fixture 103과 SPI/TWI는 아직 이 결과에 포함하지 않는다.
...
| 3 | UARTE 5개와 async RX/TX DMA | **source/build/semantic 완료 · Fixture 101·102 PASS, 추가 route HIL 대기** |
...
| 6 | 7개 온보드 + 16개 loopback/peer 기능 HIL, 충돌·허용 최대동시·복구·성능·soak | **온보드 기본·UART Fixture 101·102 PASS · 추가 기능/fixture 대기** |
