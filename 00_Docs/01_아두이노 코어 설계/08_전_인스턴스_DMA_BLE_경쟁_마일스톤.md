...
다음 순서는 메모리 최적화 → W04·W05 → W06~W08이다. `M31-MEM-OPT`의 P0·P1은 완료했고
P2가 남았다. 지원 범위 오류·최악 부하, stack/heap 여유·크기 결정, 동일 조건 Nordic native
FLASH/RAM 비교의 세 축은 [M31 TODO](../TODO_M31.md)를 따른다.
