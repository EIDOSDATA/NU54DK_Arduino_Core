...
| 문서 개정 | 1.9 |
| 문서 상태 | M23·M26 완료 / M24 온보드 기본·UART Fixture 101~103 PASS, 나머지 M24·M25 physical gate 대기 / M27 준비 중 |
...
- 상태: **작업 1~5 source/build/semantic 완료, 작업 6 온보드 기본·UART Fixture 101~103 PASS·나머지 HIL 대기** — 5개 block·23개 personality, 핀 bank, singleton/고급 API 경계,
...
| 6 | 7개 온보드 + 16개 loopback/peer 기능 HIL, 충돌·허용 최대동시·복구·성능·soak | **온보드 기본·UART Fixture 101~103 PASS · SPI/TWI와 추가 기능/fixture 대기** |
