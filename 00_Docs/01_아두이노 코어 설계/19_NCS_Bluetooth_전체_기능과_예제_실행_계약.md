...
| 현재 상태 | **M31 W01~W04 완료 4/8**. W02 설치본 ISO 11예제·11역할, W03 Audio 11/11, W04 DF 완료. W05 CS는 진행 중·미완료, W06~W08과 M32·M33은 미착수 |
...
`v0.5.0`은 M31 완료 후 Windows 우선으로 릴리스한다. 완료한 W04 다음 W05 → W06~W08
...
현재 설치·지원 `v0.4.1`, 개발 source `0.4.1-dev`, M31 4/8·M32 0/12·M33 0/8·HOST 3/8은 유지한다.
...
| 2 / P0 | M31-C W05 CS | W01 controller별 판정과 최적화 image | connected CS 예제, negative·복구 |
