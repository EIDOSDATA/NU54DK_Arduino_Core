...
| 2 / P0 | 완료한 M31-W06 독립 image 자원·수명주기·회귀와 W07 설치 예제·3보드 HIL을 입력으로 W08 릴리스 준비 | 위 기능별 build/negative. 네 기능 전체 동시 실행은 요구하지 않음 | 기능 8/8 마감과 별도 Windows package·설치·RC·공개 gate; M32 자원 인계 |
