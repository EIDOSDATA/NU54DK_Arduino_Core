...
> 이 표는 manifest의 지원 판정이며 최신 실기 결과의 자동 집계가 아닙니다. 현재 진행은 [TODO](../TODO_v0.4.0.md), source별 근거는 [검증 기록](<../04_검증 기록/README.md>)을 확인합니다. 최종 지원 반영은 T15에서 수행합니다.
...
| `egu10` | `—` / `egu10` | not-required: `internal-event` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `egu20` | `—` / `egu20` | not-required: `internal-event` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `dppic00` | `—` / `dppic00` | not-required: `domain-00` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `dppic10` | `—` / `dppic10` | not-required: `domain-10` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `dppic20` | `—` / `dppic20` | not-required: `domain-20` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `dppic30` | `—` / `dppic30` | not-required: `domain-30` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib00` | `—` / `ppib00` | not-required: `domain-00-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib01` | `—` / `ppib01` | not-required: `domain-00-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib10` | `—` / `ppib10` | not-required: `domain-10-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib11` | `—` / `ppib11` | not-required: `domain-10-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib20` | `—` / `ppib20` | not-required: `domain-20-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib21` | `—` / `ppib21` | not-required: `domain-20-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib22` | `—` / `ppib22` | not-required: `domain-20-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `ppib30` | `—` / `ppib30` | not-required: `domain-30-bridge` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer00` | `—` / `timer00` | not-required: `domain-00` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer10` | `—` / `timer10` | not-required: `domain-10` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer20` | `—` / `timer20` | not-required: `domain-20` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer21` | `—` / `timer21` | not-required: `domain-20` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer22` | `—` / `timer22` | not-required: `domain-20` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer23` | `—` / `timer23` | not-required: `domain-20` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `timer24` | `—` / `timer24` | not-required: `domain-20` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
...
| `saadc` | `—` / `adc` | partial: `ain0-ain7-policy-limited` | implemented / public: `analogRead` | EasyDMA/16 bit; driver; continuous | pass | pass | partial | not-run |
| `pwm20` | `—` / `pwm20` | verified: `header-p1-runtime` | implemented / public: `analogWrite` | EasyDMA/15 bit; driver; double-buffered | pass | pass | partial | not-run |
| `pwm21` | `—` / `pwm21` | verified: `header-p1-runtime` | implemented / public: `tone`, `noTone` | EasyDMA/15 bit; driver; double-buffered | pass | pass | not-run | not-run |
| `pwm22` | `—` / `pwm22` | verified: `header-p1-runtime` | implemented / public: `Servo` | EasyDMA/15 bit; driver; double-buffered | pass | pass | not-run | not-run |
| `pdm20` | `—` / `pdm20` | candidate: `header-p1` | implemented / internal: — | EasyDMA/16 bit; direct 예정; double-buffered | pass | pass | not-run | not-run |
| `pdm21` | `—` / `pdm21` | candidate: `header-p1` | implemented / internal: — | EasyDMA/16 bit; direct 예정; double-buffered | pass | pass | not-run | not-run |
| `i2s20` | `—` / `i2s20` | candidate: `header-p1` | implemented / internal: — | EasyDMA/16 bit; driver; double-buffered | pass | pass | not-run | not-run |
| `qdec20` | `—` / `qdec20` | candidate: `header-p1` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
| `qdec21` | `—` / `qdec21` | candidate: `header-p1` | implemented / internal: — | 없음 | pass | pass | not-run | not-run |
