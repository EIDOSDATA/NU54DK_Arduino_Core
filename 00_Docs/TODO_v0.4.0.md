...
DMA·GPIO·IRQ·RAM과 종료 원본을 보존했으며 원인은 미확정입니다. UART20·30 A와 UART21 B
CTS100회는 완료했습니다. UART21·22 A, C01·C05 A, UART20 B는 반복 중 실패했고 원본·
양쪽 정리를 보존했습니다. 기존54조건의 확정 통과는3조건이며 나머지를 실행합니다.
...
실제 OFF 성공은0회입니다. 남은 순서1~3의 확정 완료는4/58(약7%)입니다.
