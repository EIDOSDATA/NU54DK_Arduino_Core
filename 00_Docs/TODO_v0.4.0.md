...
| 다음 구체적 행동 | 준비 기준선을 commit하고 exact v0.4.0 target 20개 build, 두 UID pair runner preflight 후 onboard 시험. 실패 원인과 증거를 43번에 기록 |
...
| 이 TODO 작성 작업의 실행 중 시험 | 아직 target build/flash 전. 신규 Host protocol 9개·plan 10개, CI 계약 45개, 문서 142개 PASS |
