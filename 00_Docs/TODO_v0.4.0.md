...
완료했습니다. UART21·22 A, C01·C05 A, UART20 B는 반복 중 실패했고 원본·양쪽 정리를
보존했습니다. 기존54조건의 확정 통과는2조건이며 나머지를 실행합니다.
...
확인했습니다. 다음 진단은 A의 reset 전후 유휴선과 합성 큐 초과 뒤 최초 UART 오류를
분리하여 보존합니다. 실제 OFF 성공은0회입니다.
