...
| 항목 | 내용 |
| --- | --- |
| 문서 ID / 개정 | TODO-V04-001 / 3.45 |
| 상태 | 활성 TODO — R00~R13·기존 source별 T11 완료, T14 PWM 결함 회귀 완료, T12 외부/내부 부분 PASS·전체 미완료 |
| 작성·갱신일 | 2026-09-08 |
| 작성 직전 기준 commit | `9c587c9463e4a7041acb005418817ff6759d000b` — latency6회 뒤 계측 간격으로 중단·postflight PASS |
...
| 외부 결선 상태 | C17신호+GND·양쪽 DAP UART 분리/SWD 연결 유지 확인. 9c587c9 종료 postflight 양쪽17 GPIO 입력·주변장치 off PASS. 고정 세션은2026-09-08 07:00KST까지이며 USB/결선 변경 시 재확인 필요 |
...
| 마지막 정식 외부 HIL source | QDEC 진단9c587c9 종료(기능 PASS 아님). I2S432는b5c86a4. GPIO4e48252·steady3334b17·모드0db0689의 PASS를 새 source로 소급하지 않음 |
...
| 최종 HIL 입력 찾기 | GPIO C:/cgc04=4e48252, steady C:/cav04=3334b17, 모드 C:/caw04=0db0689, I2S C:/cax04=b5c86a4, QDEC진단 C:/cbu04=9c587c9. Raw/SHA/postflight는100·101번 |
