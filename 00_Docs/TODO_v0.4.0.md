...
**2026-09-11 v0.4.0 정식 공개와 T24/T25 완료:** 승인한 source commit `ad829439`에
`v0.4.0` tag와 GitHub Release를 공개했고, 11개 release asset과 0.4.0/0.3.0 stable index를
검증했습니다. 공개 URL에서 새로 설치한 `nucode:zephyr@0.4.0`으로 설치 예제 30/30 compile,
대표 Blink pyOCD Upload, 0.3.0 전환, 제거·재설치와 prerequisite 보존이 모두 PASS했습니다.
공개 identity·실행 결과·잔여 범위는
[125번](<04_검증 기록/125_v0.4.0_정식_릴리스_공개와_T24_T25_마감.md>)에 고정합니다.
...
완료했습니다. 후속 T22 승인과 T23~T25도 완료했습니다.
