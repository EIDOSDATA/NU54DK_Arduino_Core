...
**M28은 W01~W08·9개 test ID, M29는 W01~W08·10개 test ID를 완료했다. M30은 W01~W05와
`M30-CAP-01`·`M30-PAIR-01`·`M30-OOB-01`·`M30-BOND-01`·`M30-PROFILE-01`·`M30-BOOT-01`을 완료하고 W06을 진행 중이며 HOST-W01~W03도 완료했다.
...
현재 개발 지점은 **M30-W06 secure BLE DFU·negative·rollback**이다. M30-W01은 exact
...
unsigned·wrong-key image accept 0을 실제 한 보드에서 확인했다. 다중 Host
...
### 현재 개발 지점: M30-W06, HOST-W01~W03 완료
...
signed boot 20/20, unsigned accept 0, wrong-key accept 0을 확인했으며 power cut은 실행하지 않았다. 다음
...
[141~156번 검증 기록](<04_검증 기록/README.md>)에 보존하며 이 TODO에 중복하지 않는다.
