...
| M29-W07 | **진행 중 — Host 계약 10/10·parser 14/14·target 2/2 PASS** | exact commit 기준 `M29-SIGN/EATT/MULTI/REG-01` HIL과 증거 보존 |
...
Host 전체 24개 시나리오, source 계약 10개, strict HIL parser 14개와 고정 NCS target role 2/2가
