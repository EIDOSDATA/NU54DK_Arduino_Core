...
현재 개발 브랜치는 **`main`**이며 공개 RC의 완료 구현·문서를 통합했다.
통합 이력은 [270번 기록](<04_검증 기록/270_main_RC_통합_Squash와_문서_동기화.md>)을 따른다.
...
공개 `v0.5.0-rc.1`과 공개 다운로드·설치 smoke를 완료했다. 다음 순서는 **RC 결과 관찰과 정식
v0.5.0 stable 승격의 별도 검토·승인**이다.
