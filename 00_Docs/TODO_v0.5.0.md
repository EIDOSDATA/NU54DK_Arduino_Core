...
이 경계와 세 축의 완료는 W04/W05 마감·릴리스 승인이 아니다.

이후 구현 순서는 **W04·W05 → W06 → W07 → W08·Windows 릴리스 준비**다.
...
| --- | --- | --- |
| M31 / v0.5.0 | **3/8** | W01~W03와 메모리 최적화 P0~P2 완료. W04 DF·W05 CS → W06 독립 image 자원·수명주기·회귀 → W07 설치 예제 → W08 마감·Windows 릴리스 준비. 네 기능 전체 동시 실행은 요구하지 않음 |
...
P2 완료 수치와 기존 evidence를 유지하고 W04·W05의 잔여와 영향 재검증을 닫는다. W04·W05의
