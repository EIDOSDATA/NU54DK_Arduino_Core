...
**M28은 W01~W08·9개 test ID, M29는 W01~W08·10개 test ID를 완료했다. M30은 W01~W04와
`M30-CAP-01`·`M30-PAIR-01`·`M30-OOB-01`·`M30-BOND-01`·`M30-PROFILE-01`을 완료하고 W05를 진행 중이며 HOST-W01~W03도 완료했다.
...
현재 개발 지점은 **M30-W05 MCUboot layout·서명**이다. M30-W01은 exact
...
profile 7개와 서비스별 100 operation을 두 보드에서 payload·driver 오류 없이 완료했다. 다중 Host
...
### 현재 개발 지점: M30-W05, HOST-W01~W03 완료
...
HRS와 ESS catalog 7/7, 서비스별 100 operation과 payload/driver 오류 0을 두 보드에서 확인했다. 다음
...
[141~154번 검증 기록](<04_검증 기록/README.md>)에 보존하며 이 TODO에 중복하지 않는다.
