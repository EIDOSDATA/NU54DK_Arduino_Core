...
| M28 완료·M29 개발 | [M28 완료 기록](<04_검증 기록/140_M28_W07_3보드_HIL과_W08_완료.md>), [M29 착수 계약](<01_아두이노 코어 설계/16_M29_ATT_GATT_L2CAP_착수_계약.md>), [147번 W07 2보드 기록](<04_검증 기록/147_M29_W07_Signed_Write_EATT_HIL_준비.md>), [v0.5.0 착수 계획](TODO_v0.5.0.md) — M29 6/8·SIGN/EATT PASS, MULTI/REG NOT RUN |
...
| TODO·인계 | v0.4.0 TODO는 완료 기록, v0.5.0 TODO는 준비 체크·결정 상태. 완료 시험의 재실행 지시가 아님 |
...
- [Arduino CLI 및 IDE 통합 설계 — v0.4.0](<02_빌드 설계/03_Arduino_CLI_통합.md>)
- [빌드 캐시와 산출물 — v0.4.0 계약](<02_빌드 설계/04_빌드_캐시와_산출물.md>)
- [업로드와 디버그 — v0.4.0 지원 경계](<02_빌드 설계/05_업로드와_디버그.md>)
...
- [CI/CD와 재현 빌드 — v0.4.1 stable 현재 계약](<02_빌드 설계/08_M12_CI_CD와_재현_빌드.md>)
