...
| M28 완료·M29 이후 개발 | [M28 착수 계약](<01_아두이노 코어 설계/15_M28_BLE_GAP_Link_Privacy_착수_계약.md>), [140번 완료 기록](<04_검증 기록/140_M28_W07_3보드_HIL과_W08_완료.md>), [v0.5.0 착수 계획](TODO_v0.5.0.md) — M28 8/8·실기 9/9 PASS, M29 계획 |
