...
14. [M11 v0.1.0-rc.1 릴리스 후보 기준선](<./04_검증 기록/11_M11_v0.1.0_rc1_릴리스_후보_기준선.md>)
...
19. [v0.1.0-rc.1 릴리스 노트](<./05_릴리스/03_v0.1.0_rc1_릴리스_노트.md>)
...
- [M11 v0.1.0-rc.1 릴리스 후보 기준선](<./04_검증 기록/11_M11_v0.1.0_rc1_릴리스_후보_기준선.md>): exact RC 필수 gate 8/8, M10 retained-prerequisite 원격 회귀, pyOCD+UART HIL과 사람 승인 경계
...
| M11 v0.1 릴리스 후보 | **완료·RC 공개** | exact RC 필수 gate 8/8 PASS 후 `v0.1.0-rc.1` Prerelease 공개; stable 공개 승인 대기 |
