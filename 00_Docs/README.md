...
| 메모리 최적화 방법·진행 상태 | [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [M31 TODO](TODO_M31.md) · [CoC 송신 버퍼·복구](<04_검증 기록/257_M31_P2_CoC_송신_버퍼_부하와_복구.md>) · [Audio 양방향·종료](<04_검증 기록/258_M31_P2_Audio_양방향_장시간과_종료_복구.md>) · [DF 지원 경계](<04_검증 기록/259_M31_P2_DF_고정_SDK_지원_경계.md>) · [CS 256-step·누락](<04_검증 기록/260_M31_P2_CS_누락_분류와_256_step_장시간.md>) — P0·P1 완료, P2 네 축 후속 실기. CS 간헐 gap은 비차단이며 DF RX 지원 범위·동등 native 비용·최악 안전 여유는 미완료 |
