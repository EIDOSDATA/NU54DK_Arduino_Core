...
| 메모리 최적화 방법·진행 상태 | [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [M31 TODO](TODO_M31.md) · [P2 native/DF 후속](<04_검증 기록/250_M31_P2_native_CS_비교와_DF_재진단.md>) · [CoC 재연결](<04_검증 기록/251_M31_P2_CoC_재연결_메모리_계측.md>) · [CS 장절차 경계](<04_검증 기록/252_M31_P2_CS_장절차_반복계수_경계_진단.md>) · [Audio broadcast 재가입](<04_검증 기록/253_M31_P2_Audio_broadcast_재가입_메모리_계측.md>) · [Audio unicast 재연결](<04_검증 기록/254_M31_P2_Audio_unicast_재연결_메모리_계측.md>) — P0·P1 완료, P2 역할별 실기 진행 중. 동일 기능 native 비용·최악 안전 여유 확정 전 |
...
릴리스 전환·전수 검토는 [220번 기록](<04_검증 기록/220_M31_릴리스_전환과_문서_전수_정비.md>)과
[문서 감사 원장](document-review.json)을 따릅니다. 이후 별도 사용자 요청에 따른 main 이력 정리는
[221번 기록](<04_검증 기록/221_main_마일스톤별_이력_정리.md>)으로 분리합니다. main에서
분기한 `M31-MEM-OPT`에서 메모리 최적화 P0·P1을 완료하고 P2 실기를 진행합니다.
기존 [215번 squash 기록](<04_검증 기록/215_M31_W03_이력과_문서_정비.md>)과 old SHA는 보존합니다.
...
이후 사용자 후속 검증 책임·DF raw IQ 경계·다른 PC 재개 절차의 최종 확정은
[164번 기록](<04_검증 기록/164_사용자_후속_검증_범위와_DF_IQ_인계.md>)을 따릅니다.
