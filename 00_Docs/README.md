...
| v0.5.0 다중 Host 지원 계획 | [Windows·Ubuntu·macOS 착수 계약](<02_빌드 설계/10_v0.5.0_다중_Host_지원_착수_계약.md>) — HOST-W01~HOST-W03 완료 3/8, W04 이후 사용자 보류 |
...
최신 전수 검토·이력 squash는 [215번 기록](<04_검증 기록/215_M31_W03_이력과_문서_정비.md>)을 따릅니다.
현재 재개 지점은 `main`이며, 기능 개발과 HOST-W04 이후는 후속 지시를 기다립니다.
