...
| M31 완료·잔여 | [M31 TODO](TODO_M31.md) — W01~W05 완료 5/8, [LE Audio 11/11](<04_검증 기록/214_M31_W03_LE_Audio_Profile_완료.md>), [DF 완료](<04_검증 기록/263_M31_W04_Direction_Finding_완료.md>), [CS 완료](<04_검증 기록/264_M31_W05_Channel_Sounding_완료.md>), W06~W08 잔여 |
| 전체 Bluetooth 기능·예제 구현 | [전체 기능·예제 계약](<01_아두이노 코어 설계/19_NCS_Bluetooth_전체_기능과_예제_실행_계약.md>) — upstream·제공 방식·역할·검증 소유권 |
| v0.5.0 릴리스·다음 구현 | [v0.5.0 TODO](TODO_v0.5.0.md) — M31 완료 후 Windows 릴리스. 현재 `M31-MEM-OPT`의 P0~P2·W04·W05 완료 → W06~W08 |
| 메모리 최적화·다음 작업 | [P2 완료 세 축](TODO_M31.md#p2-완료--세-축) · [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [262번 완료 기록](<04_검증 기록/262_M31_메모리_최적화_P2_세_축_완료.md>) — P0·P1·P2·W04·W05 완료. 기존 최종 크기 유지, 다음은 W06 |
