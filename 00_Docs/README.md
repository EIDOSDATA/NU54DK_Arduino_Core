...
| M28 완료·M29 개발 | [M28 완료 기록](<04_검증 기록/140_M28_W07_3보드_HIL과_W08_완료.md>), [M29 착수 계약](<01_아두이노 코어 설계/16_M29_ATT_GATT_L2CAP_착수_계약.md>), [141번 W01 기록](<04_검증 기록/141_M29_W01_ATT_GATT_L2CAP_capability.md>), [v0.5.0 착수 계획](TODO_v0.5.0.md) — M29-W01 1/8·CAP 7/7 PASS |
