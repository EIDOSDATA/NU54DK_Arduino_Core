...
| M31 완료 | [M31 TODO](TODO_M31.md) — W01~W08 8/8 완료, [LE Audio 11/11](<04_검증 기록/214_M31_W03_LE_Audio_Profile_완료.md>), [DF](<04_검증 기록/263_M31_W04_Direction_Finding_완료.md>)·[CS](<04_검증 기록/264_M31_W05_Channel_Sounding_완료.md>)·[W06 자원/회귀](<04_검증 기록/265_M31_W06_자원_수명주기와_영향_회귀_완료.md>)·[W07 예제/HIL](<04_검증 기록/266_M31_W07_설치_예제와_3보드_역할_HIL_완료.md>)·[W08 Windows RC 준비](<04_검증 기록/267_M31_W08_Windows_RC_준비와_M31_완료.md>) 완료 |
| 전체 Bluetooth 기능·예제 구현 | [전체 기능·예제 계약](<01_아두이노 코어 설계/19_NCS_Bluetooth_전체_기능과_예제_실행_계약.md>) — upstream·제공 방식·역할·검증 소유권 |
| v0.5.0 릴리스·다음 구현 | [v0.5.0 TODO](TODO_v0.5.0.md) — `0.5.0-RC1`의 M31·Windows RC 준비 완료, 별도 공개 승인 대기 |
| 메모리 최적화 | [P2 완료 세 축](TODO_M31.md#p2-완료--세-축) · [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [262번 완료 기록](<04_검증 기록/262_M31_메모리_최적화_P2_세_축_완료.md>) — P0·P1·P2 완료, 기존 최종 크기 유지 |
...
최신 전수 감사와 W07 완료 근거는 [266번 기록](<04_검증 기록/266_M31_W07_설치_예제와_3보드_역할_HIL_완료.md>)과
[문서 감사 원장](document-review.json)을 따릅니다. 261번은 세 축을 확정한 착수 시점 기록으로 보존합니다.
과거 릴리스 전환은 [220번](<04_검증 기록/220_M31_릴리스_전환과_문서_전수_정비.md>),
...
보존합니다. 이후 확정한 제품 DF IQ RX 미지원·P2 범위는 현행 TODO와 259·262번을 우선합니다.
