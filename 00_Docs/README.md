...
현재 T11은 exact 과거 source의 단독 기능 체크포인트로 완료됐다. 다음은 바로 결선을 바꾸는 T12가
아니라 R00~R13의 정확성·구조 리팩토링과 전체 software gate다. 그 최종 source로 current-source
T11 회귀를 수행한 뒤 Fixture 401부터 T12~T15 통합 실기를 진행한다.
