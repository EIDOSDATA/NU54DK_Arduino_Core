...
| v0.5.0 릴리스·다음 구현 | [v0.5.0 TODO](TODO_v0.5.0.md) — M31 완료 후 Windows 릴리스. 현재 `M31-MEM-OPT`의 P0~P2 완료 → W04·W05 → W06~W08 |
| 메모리 최적화·다음 작업 | [P2 완료 세 축](TODO_M31.md#p2-완료--세-축) · [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [262번 완료 기록](<04_검증 기록/262_M31_메모리_최적화_P2_세_축_완료.md>) — P0·P1·P2 완료. 기존 최종 크기 유지, 다음은 W04·W05 |
