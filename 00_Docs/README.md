...
| 메모리 최적화 방법·진행 상태 | [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [M31 TODO](TODO_M31.md) · [P2 native/DF 후속](<04_검증 기록/250_M31_P2_native_CS_비교와_DF_재진단.md>) · [CoC 재연결](<04_검증 기록/251_M31_P2_CoC_재연결_메모리_계측.md>) · [CS 장절차 경계](<04_검증 기록/252_M31_P2_CS_장절차_반복계수_경계_진단.md>) · [Audio 재가입](<04_검증 기록/253_M31_P2_Audio_broadcast_재가입_메모리_계측.md>) — P0·P1 완료, P2 역할별 실기 진행 중. 동일 기능 native 비용·최악 안전 여유 확정 전 |
