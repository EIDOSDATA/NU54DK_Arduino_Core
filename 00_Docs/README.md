...
| M24~M27 | **진행 중** | M24 작업 1~2 완료(온보드 자동 7·fixture 16 분류, 공통 handover backend), 전 peripheral instance·EasyDMA·동시성 parity와 `v0.4.0` |
...
M1~M23과 정식 공개 증거, `v0.3.0` AC-01~AC-03·M19~M22 및 `v0.4.0` M23·M24 작업 1~2의 구현·검증 증거는
