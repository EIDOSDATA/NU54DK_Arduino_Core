...
| 메모리 최적화 방법·진행 상태 | [통합 설계](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md>) · [M31 TODO](TODO_M31.md) · [DF 실패·복구 후속](<04_검증 기록/256_M31_P2_DF_sync_대기_취소_진단.md>) · [CoC 재연결](<04_검증 기록/251_M31_P2_CoC_재연결_메모리_계측.md>) · [CS 256-step·분할 RAS](<04_검증 기록/255_M31_P2_CS_256_step_분할_RAS_진단.md>) · [Audio broadcast 재가입](<04_검증 기록/253_M31_P2_Audio_broadcast_재가입_메모리_계측.md>) · [Audio unicast 재연결](<04_검증 기록/254_M31_P2_Audio_unicast_재연결_메모리_계측.md>) — P0·P1 완료, P2 역할별 실기 진행 중. 동일 기능 native 비용·최악 안전 여유 확정 전 |
