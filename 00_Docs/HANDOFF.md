...
positive를 각각 두 보드 20회 × 100 유효 SDU로 통과했고 BIS negative·combined·
time sync·Audio·DF·CS, HOST-W04가 잔여입니다.
...
| 현재 개발 지점 | M30 완료. [M31 착수 계약](<01_아두이노 코어 설계/20_M31_Bluetooth_착수_계약.md>)·[165번 기록](<04_검증 기록/165_M31_W01_착수와_W02_CIS_개발_후보.md>) 기반 W02 BIS negative·combined·time sync 진행 |
...
M31/M32/M33은 1/8·0/12·0/8, HOST는 3/8입니다. 현재 보드 작업은 W02 CIS·BIS positive 이후
BIS negative·combined·time sync부터 이어갑니다. HOST-W04는 별도 병행 구현 잔여입니다.
