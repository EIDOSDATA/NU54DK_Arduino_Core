...
| 메모리 최적화 | **P0 완료, P1 진행.** resolver·probe/cache·Core adaptive 생성과 55개 고정 image gate를 완료했습니다. P1 첫 변경으로 pin별 transaction lease 중복을 제거해 adaptive SPI 정적 RAM을 50,877→25,405 B로 25,472 B 줄였고 27,000 B 상한과 AC-02A target build를 고정했습니다. 다음은 UART20 boot lease, SPI route와 GATT 저장소 right-size입니다. | [219번 계약](<04_검증 기록/219_M31_W06_메모리_점유_감사와_최적화_계약.md>) · [222번 P0 완료](<04_검증 기록/222_M31_메모리_최적화_P0_완료.md>) · [223번 P1 GPIO](<04_검증 기록/223_M31_메모리_최적화_P1_GPIO_상태_절감.md>) · [통합 설계 §5.0](<01_아두이노 코어 설계/21_M31_메모리_최적화_통합_설계.md#50-구현-진행-기록>) |
