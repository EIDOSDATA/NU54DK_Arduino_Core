...
| M31-W02 raw ISO 기반 | **진행 중** | CIG/CIS central·peripheral, BIG/BIS source·receiver, combined CIS/BIS 적용성, ISO time sync, buffer·sequence·timestamp·암호화·해제·재시작 | 두 보드 20회×100 clean CIS·[BIS positive](<04_검증 기록/evidence/m31-w02-exact-c097b15d/bis-manifest.json>)·[time sync](<04_검증 기록/evidence/m31-w02-exact-504badee/time-manifest.json>) PASS; BIS negative·combined·역할 예제 잔여 |
