...
상태 전이 거부 40회, 원격 ASCS unsupported codec·invalid QoS 거부 각 20회까지
진행했다. Arduino 양방향 stream과 원격 ASCS의 잘못된 ASE 상태 제어는
미완료이며, 나머지 행은 계획/조사 단계다.
