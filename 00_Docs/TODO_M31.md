...
| M31-W05 connected Channel Sounding | **진행 중** | secure ACL·raw RAS 100개와 stop/restart·disconnect/reconnect 각 20/20을 확인했다. 간헐 counter 누락은 500건 × 2 국소 PASS 뒤에도 1,000건 장기 시험에 남는다. 장절차·반복 3 진단도 실제 93~98 step이라 256-step·fragmented RAS는 미검증이다. flash 직후 중단의 단일 원인·wrong-key negative 역시 잔여다. 비보정 RTT의 정확도는 미보증이다. | [비암호화 거부](<04_검증 기록/217_M31_W05_비암호화_RAS_ATT_오류_진단.md>) · [flash 직후 복구](<04_검증 기록/218_M31_W05_flash_직후_RAS_복구_재검증.md>) · [장기 누락 진단](<04_검증 기록/245_M31_P2_CS_장기_연속성_진단.md>) · [장절차 경계](<04_검증 기록/252_M31_P2_CS_장절차_반복계수_경계_진단.md>) |
