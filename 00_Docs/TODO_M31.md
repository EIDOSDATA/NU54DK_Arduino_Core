...
| --- | --- |
| 대상 제품선 | `v0.5.0` |
| 현재 상태 | **W01 완료, W02 구현 진행 중 / 완료 1/8 작업 묶음** |
...
계획 개정 자체는 구현 증거가 아니다. 현행 W01 완료·W02 개발과 미완료 범위는
...
| M31-W02 raw ISO 기반 | **진행 중** | CIG/CIS central·peripheral, BIG/BIS source·receiver, combined CIS/BIS 적용성, ISO time sync, buffer·sequence·timestamp·암호화·해제·재시작 | 두 보드 20회×100 clean CIS와 [BIS positive](<04_검증 기록/evidence/m31-w02-exact-c097b15d/bis-manifest.json>) PASS; BIS negative·combined·time sync·역할 예제 잔여 |
