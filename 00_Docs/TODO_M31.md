...
| M31-W03 전체 LE Audio profile | **진행 중** | Arduino LC3 내부 loopback, native BAP unicast 양방향 ISO 및 LC3 decode, 공개 Arduino BAP sink의 실제 LC3 1,000 frame decode·drop 0 확인. Arduino client/source와 §3의 나머지 profile·negative·반복 복구는 잔여. BAP sink RAM 225,024 B(85%) | profile·role별 예제와 build/runtime 상태, 기능 HIL·negative, 자원 예산·외부 I/O 경계; [native BAP LC3](<04_검증 기록/181_M31_W03_native_BAP_LC3_실제_무선_전송.md>)·[Arduino sink](<04_검증 기록/182_M31_W03_Arduino_BAP_unicast_LC3_sink_실기.md>) |
