...
`W03-03`은 비암호화 broadcast LC3와 명시적 stop/restart 재가입 20/20을 확인했지만
Broadcast Code·wrong code·강제 sync loss가 남은 부분 구현이다. 나머지 profile 행은 계획/조사 단계다.
