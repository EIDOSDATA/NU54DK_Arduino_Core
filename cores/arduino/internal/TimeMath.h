...
namespace nucode::arduino::internal
{
	 ...
	 */
	[[nodiscard]] constexpr int32_t nextSleepChunkMilliseconds(
		int64_t remaining_milliseconds) noexcept
	{
	 ...
	 */
	[[nodiscard]] constexpr uint32_t nextBusyWaitChunkMicroseconds(
		uint32_t remaining_microseconds) noexcept
	{
