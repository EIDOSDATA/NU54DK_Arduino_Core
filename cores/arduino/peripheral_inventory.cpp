...
#include "generated/PeripheralInventory.inc"
	...
	const PeripheralDescriptor *findPeripheralByObject(
	...
	const char *peripheralVerificationStateToken(
	...
	std::size_t formatPeripheralIdentity(const PeripheralDescriptor &descriptor,
										 char *buffer,
