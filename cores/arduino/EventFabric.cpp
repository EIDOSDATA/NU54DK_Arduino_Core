...
TimerContext timer_contexts[] = {
    {0U, NRF_TIMER00, 0U, 6U},   {10U, NRF_TIMER10, 10U, 8U},
    {20U, NRF_TIMER20, 20U, 6U}, {21U, NRF_TIMER21, 20U, 6U},
    {22U, NRF_TIMER22, 20U, 6U}, {23U, NRF_TIMER23, 20U, 6U},
...
PpibContext ppib_contexts[] = {
    {0U, NRF_PPIB00, 0U, 8U},   {1U, NRF_PPIB01, 0U, 8U},
    {10U, NRF_PPIB10, 10U, 8U}, {11U, NRF_PPIB11, 10U, 16U},
    {20U, NRF_PPIB20, 20U, 8U}, {21U, NRF_PPIB21, 20U, 16U},
...
[[nodiscard]] EventFabricResult claimResources(ChannelContext &context,
  ...
  const IoResourceResult reserve_result = internal::reserveIoResources(
      owner, resources, count, IoAcquirePolicy::exclusive, context.lease);
...
[[nodiscard]] bool timerPrescaler(std::uint32_t frequency_hz,
  ...
  static constexpr std::uint32_t frequencies[] = {
      16000000U, 8000000U, 4000000U, 2000000U, 1000000U,
      500000U,   250000U,  125000U,  62500U,   31250U,
  };
