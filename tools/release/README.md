...
현재 정식 버전은 **v0.4.0**이며 T01~T25를 완료했습니다. 설치·지원 문서는
[릴리스 안내](../../00_Docs/05_릴리스/README.md), 릴리스 도구의 계약과 완료 절차는
[M27 안내](M27_README.md)를 확인합니다.
...
v0.3.0 payload는 유지했고 catalog만 당시 공급 목록으로 갱신했습니다. 이후 v0.4.0 공개로
stable catalog는 `0.4.0`, `0.3.0`을 제공합니다. M18/M22의 과거 index identity와 역사 버전
생성 allowlist는 재현·감사용이며 현재 공개 공급 목록을 뜻하지 않습니다.
