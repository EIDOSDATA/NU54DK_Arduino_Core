...
> identity를 새로 고정한 별도 실행 계획을 사용한다. 해당 preview는 2026-09-08 공급 종료됐으므로
> 아래 공개 URL 기반 명령은 현재 재실행 안내가 아니다. [보존 기록](<../../../00_Docs/04_검증 기록/106_Git_이력_정리와_구버전_패키지_공급_종료.md>)을 참조한다.
