...
- `package_nucode_nu54dk_preview_index.json`과 `0.0.94`, `0.0.95` archive가 공개 URL에서 다운로드 가능
...
4. `nucode:zephyr@0.0.94` 설치와 `post_install.bat` 실행
...
13. 최신 `0.0.95` reinstall, Nordic 재검증 및 Blink compile
