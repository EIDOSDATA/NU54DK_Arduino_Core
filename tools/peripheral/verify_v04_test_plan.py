...
def render(plan: dict, inventory: list[dict], root: Path = ROOT) -> str:
    ...
    lines = ["# v0.4.0 기능 시험 목록", "", "이 문서는 `v04_test_plan.json`에서 생성한다. 손으로 수정하지 않는다.", "",
             ...
             "- S 정상 36조건(C05 3600초 포함), 요청한 S 복구 범위와 U 실기를 종료했다. T14 충돌 판정은 완료했고 T15 최종 지원 판정은 남아 있다. [115번 U 완료](<../04_검증 기록/115_T13_U_UART00_완료와_T13_종료.md>), [116번 T14 완료](<../04_검증 기록/116_T14_자원_충돌_판정과_PWM_식별_교정.md>)와 [TODO](../TODO_v0.4.0.md)를 따른다.",
