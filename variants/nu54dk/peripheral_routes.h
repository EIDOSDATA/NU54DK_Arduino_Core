...
namespace nucode::arduino::internal
{
	 ...
	 */
	[[nodiscard]] PeripheralRouteBuildError buildPeripheralRoute(
	...
	[[nodiscard]] PeripheralRouteBuildError defaultSerial1Route(
		PeripheralRouteConfiguration &configuration) noexcept;

	/** @brief 보드 DTS i2c22_default의 SDA/SCL route를 생성합니다. */
	[[nodiscard]] PeripheralRouteBuildError defaultWireRoute(
		PeripheralRouteConfiguration &configuration) noexcept;

	/** @brief 보드 DTS spi00_default의 SCK/MISO/MOSI route를 생성합니다. */
	[[nodiscard]] PeripheralRouteBuildError defaultSpiRoute(
		PeripheralRouteConfiguration &configuration) noexcept;
