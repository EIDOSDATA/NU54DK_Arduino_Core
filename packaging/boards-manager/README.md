...
현재 개발 source version은 `0.4.1-dev`입니다. M28~M31 완료와 `0.5.0-rc.1` Windows RC 준비는 공개
v0.4.1 ZIP에 자동으로 추가되지 않으며 v0.5.0 패키지는 아직 공개하지 않았습니다. M31-W08까지
완료했고 공개 승인·tag·Release·catalog·공개 download smoke는 남아 있습니다. HOST-W04~HOST-W08은
...
| 미공개 `v0.5.0` | M31 8/8 뒤 Windows 최종 package·설치·예제·lifecycle·RC gate를 마감; 새 version 전용 공개 계약 필요 |
