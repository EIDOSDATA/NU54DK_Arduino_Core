...
v0.5.0의 [최종 기능·예제 계약](<../../00_Docs/01_아두이노 코어 설계/19_NCS_Bluetooth_전체_기능과_예제_실행_계약.md>)에서는
Apple/Google·외장 장치의 사용 가능한 구현·예제·설정/연결 안내·자동 검사를 필수로 하고, 실제
...
사용자가 최종 릴리스 단계에서 검증하며 최종 Host 지원 gate를 유지합니다. 중간 구현·package 준비는
해당 실물 PC를 기다리지 않습니다. 이 범위는 다음 원장/검증기 구현 계약이며 현재 도구에 자동 적용된 것이 아닙니다.
