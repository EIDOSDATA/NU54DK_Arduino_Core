/**
 * @file WireWhoAmI.ino
 * @brief 고정된 LSM6DS3TR-C WHO_AM_I register를 repeated-start로 읽습니다.
 *
...
namespace
{
	...
	constexpr uint8_t imu_address = 0x6BU;

	/** @brief LSM6DS3TR-C WHO_AM_I register입니다. */
	constexpr uint8_t who_am_i_register = 0x0FU;

	/** @brief LSM6DS3TR-C가 반환해야 하는 WHO_AM_I 값입니다. */
	constexpr uint8_t who_am_i_expected = 0x6AU;
