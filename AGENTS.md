...
- **개발 브랜치의 M28·M29·M30은 완료했습니다.** M30은 W01~W08 8/8, test ID 10/10,
  ...
  HOST-W04~HOST-W08은 사용자 지시로 보류 중입니다. M31은 W01~W06 완료 **6/8**이며,
  W03 LE Audio는 **11/11**입니다. W04 DF·W05 CS·W06 자원/영향 회귀를 완료했고 W07~W08은 미착수입니다.
  다음 개발은 `M31-MEM-OPT`의 W07 설치 예제·역할 HIL → W08 마감
...
- **P2 세 기술 축은 완료**했다: 지원 범위 오류·최악 부하, stack/heap 안전 여유·최종 크기,
  ...
  영향 회귀를 완료했다. 세부 근거는 [M31 TODO](00_Docs/TODO_M31.md#p2-완료--세-축)를 따른다.
