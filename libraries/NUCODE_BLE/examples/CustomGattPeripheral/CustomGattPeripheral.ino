...
nucode::ble::BLECharacteristic customValue(
    valueUuid,
...
void setup()
{
    ...
    if (!customValue.setValue(initial, sizeof(initial)) ||
        !customService.addCharacteristic(customValue) ||
        !BLEDevice.addService(customService) || !BLEDevice.begin("NU54-GATT-P") ||
        !BLEAdvertising.clear() || !BLEAdvertising.addServiceUuid(serviceUuid) ||
